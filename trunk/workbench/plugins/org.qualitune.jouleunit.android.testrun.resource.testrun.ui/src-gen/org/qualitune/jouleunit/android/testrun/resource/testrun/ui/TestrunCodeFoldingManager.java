 ...
 */
public class TestrunCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor) {
				org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor editor = (org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor) workbenchPart;
	...
	protected org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor editor;
	 ...
	 */
	public TestrunCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor textEditor) {
	...
	private void addCloseListener(final org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource textResource = (org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
