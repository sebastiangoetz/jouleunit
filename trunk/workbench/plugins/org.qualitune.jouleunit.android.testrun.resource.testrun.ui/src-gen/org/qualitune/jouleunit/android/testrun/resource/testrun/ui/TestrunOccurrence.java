 ...
 */
public class TestrunOccurrence {
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.qualitune.jouleunit.android.testrun.resource.testrun.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.qualitune.jouleunit.android.testrun.resource.testrun.ui.occurences.declaration";
	...
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunTokenScanner tokenScanner;
	 ...
	 */
	public TestrunOccurrence(org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMetaInformation().getTokenNames();
	 ...
	 */
	public void handleOccurrenceHighlighting(org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBracketSet bracketSet) {
		if (textResource == null) {
			return;
		}
		org.eclipse.swt.custom.StyledText textWidget = projectionViewer.getTextWidget();
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addAnnotation(document, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPositionCategory.DEFINTION, text);
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if (elementsAtDefinition.contains(occEO) || definitionElement.equals(occEO)) {
						addAnnotation(document, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPositionCategory.PROXY, text);
					}
				}
			}
			token = tokenScanner.nextToken();
	...
	private void addAnnotation(org.eclipse.jface.text.IDocument document, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPositionCategory type, String text) {
		int tokenOffset = tokenScanner.getTokenOffset();
		int tokenLength = tokenScanner.getTokenLength();
		...
		if (type == org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPositionCategory.DEFINTION) {
	...
	private void removeAnnotations() {
		removeAnnotations(org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunOccurrence.DECLARATION_ANNOTATION_ID);
	}
