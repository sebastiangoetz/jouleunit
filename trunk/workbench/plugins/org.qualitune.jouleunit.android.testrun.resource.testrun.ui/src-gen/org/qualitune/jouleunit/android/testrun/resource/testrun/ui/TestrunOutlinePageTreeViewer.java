 ...
 * a specified depth.
 */
public class TestrunOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public TestrunOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunPlugin.logError("Exception while refreshing outline view", e);
		}
	}
