 ...
 * </ul>
 */
public class TestrunBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMetaInformation().getSyntaxName();
	
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public TestrunBracketPreferencePage() {
		super();
		
		org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunMetaInformation metaInformation = new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunUIPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(language + org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor) {
			((org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor) editor).invalidateTextRepresentation();
		}
	}
