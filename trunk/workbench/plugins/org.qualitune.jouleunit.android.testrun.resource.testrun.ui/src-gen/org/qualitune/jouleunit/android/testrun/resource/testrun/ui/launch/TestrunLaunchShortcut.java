 ...
 */
public class TestrunLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(org.qualitune.jouleunit.android.testrun.resource.testrun.launch.TestrunLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunPlugin.logError("Exception while launching selection", e);
		}
	}
