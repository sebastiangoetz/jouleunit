...
public class TestrunAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMetaInformation().getSyntaxName())) {
					return new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.debug.TestrunLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugVariable) {
			final org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugVariable variable = (org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugVariable) {
			final org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugVariable variable = (org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugValue castedValue = (org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugValue) value;
