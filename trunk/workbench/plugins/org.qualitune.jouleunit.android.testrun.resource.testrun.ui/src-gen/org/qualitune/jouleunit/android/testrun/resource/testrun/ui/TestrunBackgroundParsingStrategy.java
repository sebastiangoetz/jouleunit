 ...
 */
public class TestrunBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource resource, final org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource resource, final org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource resource, final org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunResource) {
							org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunResource concreteResource = (org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunResource) resource;
