 ...
 * 
 */
package org.qualitune.jouleunit.android.testrun.resource.testrun.ui.debug;

public class TestrunLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunPlugin.DEBUG_MODEL_ID);
			...
			org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunLineBreakpoint lineBreakpoint = new org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunLineBreakpoint(resource, lineNumber + 1);
	...
	private org.eclipse.ui.texteditor.ITextEditor getEditor(org.eclipse.ui.IWorkbenchPart part) {
		if (part instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMetaInformation().getSyntaxName())) {
					return editorPart;
				}
			}
		}
