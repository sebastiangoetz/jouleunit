 ...
 */
public class TestrunStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunFunction1<String, T> toStringFunction) {
