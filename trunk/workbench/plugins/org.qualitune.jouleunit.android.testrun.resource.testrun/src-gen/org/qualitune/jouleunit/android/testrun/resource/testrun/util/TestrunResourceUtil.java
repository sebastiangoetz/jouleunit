 ...
 */
public class TestrunResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunResource getResource(java.io.File file) {
	...
	public static org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunResource) resource;
	}
	 ...
	 */
	public static org.qualitune.jouleunit.android.testrun.TestRun getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.qualitune.jouleunit.android.testrun.TestRun getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.qualitune.jouleunit.android.testrun.TestRun) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static org.qualitune.jouleunit.android.testrun.TestRun getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource resource = (org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
