 ...
 * contains
 * <code>org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextDiagn
 * ostic</code>s it uses the more precise information of this extended diagnostic
 * type.
 */
public class TestrunMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunCommand<Object>> commands = new java.util.ArrayList<org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunCommand<Object>> commandsToProcess = new java.util.ArrayList<org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextDiagnostic diagnostic) {
		final org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunProblem problem = diagnostic.getProblem();
		org.qualitune.jouleunit.android.testrun.resource.testrun.TestrunEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.qualitune.jouleunit.android.testrun.resource.testrun.TestrunEProblemSeverity.ERROR) {
					...
					org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextDiagnostic textDiagnostic = (org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.qualitune.jouleunit.android.testrun.resource.testrun.TestrunEProblemType nextType : org.qualitune.jouleunit.android.testrun.resource.testrun.TestrunEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.qualitune.jouleunit.android.testrun.resource.testrun.TestrunEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.qualitune.jouleunit.android.testrun.resource.testrun.TestrunEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.qualitune.jouleunit.android.testrun.resource.testrun.TestrunEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
