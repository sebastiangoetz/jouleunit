...
/**
 * A TestrunLayoutInformationAdapter is used to store layout information that is
 ...
 * TestrunLayoutInformationAdapters are attached to EObjects and aggregate
 ...
 */
public class TestrunLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunLayoutInformation> layoutInformations = new java.util.ArrayList<org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunLayoutInformation>();
	...
	public java.util.List<org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunLayoutInformation layoutInformation) {
