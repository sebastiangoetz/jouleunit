 ...
 */
public class TestrunDefaultTokenResolver implements org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTokenResolver {
	 ...
	 */
	public TestrunDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public TestrunDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.qualitune.jouleunit.android.testrun.resource.testrun.grammar.TestrunGrammarInformationProvider.INSTANCE.getKeywords()) {
