...
public class TestrunDebugTarget extends org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugElement implements org.eclipse.debug.core.model.IDebugTarget, org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ITestrunDebugEventListener {
	
	/**
	 * associated system process
	 */
	private org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugProcess process;
	...
	private org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugThread thread;
	 ...
	 * event listeners
	 */
	private java.util.List<org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ITestrunDebugEventListener> eventListeners = new java.util.ArrayList<org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ITestrunDebugEventListener>();
	
	private org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugProxy debugProxy;
	...
	private class DebugEventDispatcher extends org.eclipse.core.runtime.jobs.Job {
		...
		public DebugEventDispatcher() {
			super(new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMetaInformation().getSyntaxName() + " Event Dispatch");
			setSystem(true);
		}
		
		protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
			while (!isTerminated()) {
				org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugMessage message = communicationHelper.receive(eventReader);
				if (message != null) {
		...
		private void notifyListeners(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugMessage message) {
			Object[] listeners = eventListeners.toArray();
			for (int i = 0; i < listeners.length; i++) {
				((org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ITestrunDebugEventListener) listeners[i]).handleMessage(message);
			}
		}
	}
	
	public TestrunDebugTarget(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugProcess process, org.eclipse.debug.core.ILaunch launch, int requestPort, int eventPort) {
		super(launch.getDebugTarget());
		this.process = process;
		this.launch = launch;
		this.thread = new org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugThread(this);
		this.threads = new org.eclipse.debug.core.model.IThread[] {this.thread};
		
		// initialize debug proxy
		try {
			this.debugProxy = new org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugProxy(this, requestPort);
	 ...
	 */
	public void addEventListener(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ITestrunDebugEventListener listener) {
	 ...
	 * @param listener event listener
	 */
	public void removeEventListener(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ITestrunDebugEventListener listener) {
		eventListeners.remove(listener);
	}
	
	public String getName() throws org.eclipse.debug.core.DebugException {
		return new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMetaInformation().getSyntaxName() + " model";
	}
		...
		if (supportsBreakpoint(breakpoint)) {
			try {
				if ((breakpoint.isEnabled() && getBreakpointManager().isEnabled()) || !breakpoint.isRegistered()) {
					org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunLineBreakpoint lineBreakpoint = (org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunLineBreakpoint) breakpoint;
	...
	public org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugProxy getDebugProxy() {
