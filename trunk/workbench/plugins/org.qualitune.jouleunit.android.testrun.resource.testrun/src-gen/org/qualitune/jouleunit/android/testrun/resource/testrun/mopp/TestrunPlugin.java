 ...
 */
public class TestrunPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.qualitune.jouleunit.android.testrun.resource.testrun";
	/**
	...
	private static TestrunPlugin plugin;
	
	public TestrunPlugin() {
		super();
	}
	...
	public static TestrunPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, TestrunPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, TestrunPlugin.PLUGIN_ID, message);
		}
		final TestrunPlugin pluginInstance = TestrunPlugin.getDefault();
