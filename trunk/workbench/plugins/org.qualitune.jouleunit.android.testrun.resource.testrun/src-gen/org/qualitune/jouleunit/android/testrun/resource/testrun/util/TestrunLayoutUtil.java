 ...
 */
public class TestrunLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		org.qualitune.jouleunit.android.testrun.resource.testrun.grammar.TestrunSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), org.qualitune.jouleunit.android.testrun.resource.testrun.grammar.TestrunGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		org.qualitune.jouleunit.android.testrun.resource.testrun.grammar.TestrunSyntaxElement syntaxElement = org.qualitune.jouleunit.android.testrun.resource.testrun.grammar.TestrunGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof org.qualitune.jouleunit.android.testrun.resource.testrun.grammar.TestrunPlaceholder) {
			org.qualitune.jouleunit.android.testrun.resource.testrun.grammar.TestrunPlaceholder placeholder = (org.qualitune.jouleunit.android.testrun.resource.testrun.grammar.TestrunPlaceholder) syntaxElement;
			org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTokenResolver tokenResolver = new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTokenResolveResult result = new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
