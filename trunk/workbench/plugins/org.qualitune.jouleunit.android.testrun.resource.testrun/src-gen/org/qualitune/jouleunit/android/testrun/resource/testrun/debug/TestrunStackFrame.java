...
public class TestrunStackFrame extends org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugTarget target;
	private String name;
	private int id;
	...
	public TestrunStackFrame(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunStringUtil.decode(data, ',');
	...
	private org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunStackFrame other = (org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunStackFrame) obj;
		if (name == null) {
