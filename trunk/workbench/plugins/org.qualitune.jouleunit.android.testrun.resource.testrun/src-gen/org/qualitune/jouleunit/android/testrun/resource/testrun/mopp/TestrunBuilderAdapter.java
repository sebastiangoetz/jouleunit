...
public class TestrunBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "org.qualitune.jouleunit.android.testrun.resource.testrun.builder";
	
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBuilder defaultBuilder = new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunResource customResource = (org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunResource) resourceSet.getResource(uri, true);
			new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMarkerHelper().getMarkerID(org.qualitune.jouleunit.android.testrun.resource.testrun.TestrunEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunTaskItemBuilder taskItemBuilder = new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunTaskItemBuilder();
		new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMetaInformation().getSyntaxName())) {
