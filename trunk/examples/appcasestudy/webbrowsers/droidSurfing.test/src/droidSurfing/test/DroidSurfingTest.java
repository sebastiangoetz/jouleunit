...
public class DroidSurfingTest extends ActivityInstrumentationTestCase2 {
	...
	private static final String ACTIVITY_SIMPLE_NAME = "MainActivity";

	/** Tag for logging during testing. */
	public static final String LOG_TAG = "TestRunner";

	/** ID of the app under test's main activity. */
	private static final String LAUNCHER_ACTIVITY_FULL_CLASSNAME = "com.ovmobile.droidsurfing.ui.activities.MainActivity";
	...
	public DroidSurfingTest() throws ClassNotFoundException {
	...
	public void subtest25_DownloadLargePdf() {
		...
		File file = new File("./sdcard/droidsurfing/downloads/large.pdf");
	...
	public void subtest27_DownloadSmallPdf() {
		...
		File file = new File("./sdcard/droidsurfing/downloads/small.pdf");
	...
	private void clearCache() {
		...
		solo.sleep(100);
		solo.clickOnText("Manage bookmarks and history");
		solo.sleep(100);
		solo.clickOnText("Clear history and/or bookmarks");
		solo.sleep(100);
	...
	private void openWebsite(String url) {
		...
		/* Close the nasty advertisement. */
		// solo.clickOnText("No Thanks");

		/* Probably get the text field back. */
		List<EditText> texts = solo.getCurrentEditTexts();

		// if (texts.size() == 0) {
		solo.clickOnScreen(770, 1170);
		texts = solo.getCurrentEditTexts();
		// }
		// no else.
