This is an example project using the JouleUnit framework to profile
and test a simple Java application for a Nao humanoid robot.

The example requires the Nao Service Utility classes to connect to
