...
public class TestrunNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.qualitune.jouleunit.android.testrun.resource.testrun.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
