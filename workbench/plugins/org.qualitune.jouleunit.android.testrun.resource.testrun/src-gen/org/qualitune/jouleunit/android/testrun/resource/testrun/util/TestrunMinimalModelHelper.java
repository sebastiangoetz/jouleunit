 ...
 */
public class TestrunMinimalModelHelper {
	
	private final static org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunEClassUtil eClassUtil = new org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if (attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunStringUtil.capitalize(attribute.getName());
					}
					Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunListUtil.castListUnchecked(value);
