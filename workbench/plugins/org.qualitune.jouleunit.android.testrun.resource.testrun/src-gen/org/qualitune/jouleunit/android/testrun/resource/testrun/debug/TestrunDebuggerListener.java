 ...
 * code).
 */
public class TestrunDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.qualitune.jouleunit.android.testrun.resource.testrun.debug.AbstractTestrunDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunPair<String, Object>>();
	...
	public TestrunDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ETestrunDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ETestrunDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ETestrunDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ETestrunDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ETestrunDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ETestrunDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ETestrunDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ETestrunDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunStringUtil.encode('#', stack);
				org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugMessage message = new org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugMessage(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ETestrunDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ETestrunDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugMessage message = new org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugMessage(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ETestrunDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ETestrunDebugMessageTypes.GET_VARIABLES)) {
				...
				org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugMessage message = new org.qualitune.jouleunit.android.testrun.resource.testrun.debug.TestrunDebugMessage(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ETestrunDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunPair<String, Object> pair = new org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunPair<String, Object>(name, value);
	...
	public org.qualitune.jouleunit.android.testrun.resource.testrun.debug.AbstractTestrunDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.AbstractTestrunDebuggable debuggable) {
