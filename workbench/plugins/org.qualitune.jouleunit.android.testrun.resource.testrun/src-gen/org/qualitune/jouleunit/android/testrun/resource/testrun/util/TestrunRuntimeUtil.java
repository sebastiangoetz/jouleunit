 ...
 */
public class TestrunRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
