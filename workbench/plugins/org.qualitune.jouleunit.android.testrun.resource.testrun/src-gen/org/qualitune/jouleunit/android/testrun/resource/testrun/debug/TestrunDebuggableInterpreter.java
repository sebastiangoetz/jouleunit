 ...
 */
public class TestrunDebuggableInterpreter<ResultType, ContextType> extends org.qualitune.jouleunit.android.testrun.resource.testrun.debug.AbstractTestrunDebuggable {
	
	/**
	 * The actual interpreter. Interpretation is delegated to this object.
	 */
	private org.qualitune.jouleunit.android.testrun.resource.testrun.util.AbstractTestrunInterpreter<ResultType, ContextType> interpreterDelegate;
	
	/**
	 * To check whether we must stop the execution after step over/into/return, we use
	 * a closure
	 */
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunCommand<org.eclipse.emf.ecore.EObject> stopCondition;
	...
	public TestrunDebuggableInterpreter(org.qualitune.jouleunit.android.testrun.resource.testrun.util.AbstractTestrunInterpreter<ResultType, ContextType> interpreterDelegate, int eventPort) {
		this.eventPort = eventPort;
		this.interpreterDelegate = interpreterDelegate;
		this.interpreterDelegate.addListener(new org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunInterpreterListener() {
	...
	public String[] getStack() {
		...
		for (org.eclipse.emf.ecore.EObject parent : parents) {
			String serializedStackElement = org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunStringUtil.encode(',', new String[] {parent.eClass().getName(), Integer.toString(stackFrameID), parent.eResource().getURI().toString(), Integer.toString(getLine(parent)), Integer.toString(getCharStart(parent)), Integer.toString(getCharEnd(parent))});
	...
	public org.qualitune.jouleunit.android.testrun.resource.testrun.util.AbstractTestrunInterpreter<ResultType, ContextType> getInterpreterDelegate() {
		return interpreterDelegate;
	}
	
	private int getLine(org.eclipse.emf.ecore.EObject element) {
		int line = -1;
		org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunLocationMap locationMap = getLocationMap(element);
		if (locationMap != null) {
	...
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunLocationMap getLocationMap(org.eclipse.emf.ecore.EObject element) {
	...
	private void evaluateStep(org.eclipse.emf.ecore.EObject element) {
		...
		org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunCommand<org.eclipse.emf.ecore.EObject> stopCheck = stopCondition;
		if (stopCheck != null && stopCheck.execute(element)) {
			stopCondition = null;
			// suspending after step...
			setSuspend(true);
			sendEvent(org.qualitune.jouleunit.android.testrun.resource.testrun.debug.ETestrunDebugMessageTypes.SUSPENDED, true);
			return;
		}
		waitIfSuspended();
	}
	...
	public void stepOver() {
		...
		final int currentLevel = org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunEObjectUtil.getDepth(current);
		stopCondition = new org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunCommand<org.eclipse.emf.ecore.EObject>() {
			public boolean execute(org.eclipse.emf.ecore.EObject element) {
				...
				int depth = org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunEObjectUtil.getDepth(element);
	...
	public void stepReturn() {
		...
		final int parentLevel = org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunEObjectUtil.getDepth(current) - 1;
		stopCondition = new org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunCommand<org.eclipse.emf.ecore.EObject>() {
			public boolean execute(org.eclipse.emf.ecore.EObject element) {
