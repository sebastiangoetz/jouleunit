 ...
 */
public class TestrunEnumerationTerminal extends org.qualitune.jouleunit.android.testrun.resource.testrun.grammar.TestrunTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public TestrunEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, org.qualitune.jouleunit.android.testrun.resource.testrun.grammar.TestrunCardinality cardinality, int mandatoryOccurrencesAfter) {
