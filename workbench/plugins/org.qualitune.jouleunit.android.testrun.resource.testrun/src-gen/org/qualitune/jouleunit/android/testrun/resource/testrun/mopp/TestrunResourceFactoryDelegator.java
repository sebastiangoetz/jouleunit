...
public class TestrunResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public TestrunResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (new org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunRuntimeUtil().isEclipsePlatformAvailable()) {
			new org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunResourceFactory());
		}
	}
