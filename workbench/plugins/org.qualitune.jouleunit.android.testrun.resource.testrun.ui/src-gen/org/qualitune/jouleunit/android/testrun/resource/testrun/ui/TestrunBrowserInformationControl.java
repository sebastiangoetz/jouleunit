 ...
 * @since 3.2
 */
public class TestrunBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunDocBrowserInformationControlInput fInput;
	 ...
	 */
	public TestrunBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public TestrunBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public TestrunBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunDocBrowserInformationControlInput);
		...
		fInput= (org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunDocBrowserInformationControlInput) input;
		...
		org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunDocBrowserInformationControlInput getInput() {
		return fInput;
	}
