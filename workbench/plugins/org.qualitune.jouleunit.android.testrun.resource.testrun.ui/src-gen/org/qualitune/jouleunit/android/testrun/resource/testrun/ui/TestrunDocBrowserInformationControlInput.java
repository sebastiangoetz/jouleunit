 ...
 * olInput</code>.
 */
public class TestrunDocBrowserInformationControlInput {
	
	private final TestrunDocBrowserInformationControlInput fPrevious;
	private TestrunDocBrowserInformationControlInput fNext;
	 ...
	 */
	public TestrunDocBrowserInformationControlInput(TestrunDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public TestrunDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public TestrunDocBrowserInformationControlInput getNext() {
		return fNext;
	}
