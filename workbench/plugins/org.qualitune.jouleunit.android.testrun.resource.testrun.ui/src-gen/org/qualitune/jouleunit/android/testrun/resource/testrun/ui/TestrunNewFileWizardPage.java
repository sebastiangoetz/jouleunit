 ...
 */
public class TestrunNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public TestrunNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new testrun file");
