 ...
 */
public class TestrunNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public TestrunNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.qualitune.jouleunit.android.testrun.resource.testrun.ui");
							...
							String natureID = org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunNature.NATURE_ID;
							...
							for (String builderID : org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMetaInformation info = new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunUIPlugin.getDefault().getBundle();
