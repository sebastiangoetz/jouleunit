 ...
 */
public class TestrunHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public TestrunHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
