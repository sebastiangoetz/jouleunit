 ...
 */
public class TestrunTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunDocBrowserInformationControlInput infoInput = (org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunHyperlink hyperlink = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBrowserInformationControl iControl = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunDocBrowserInformationControlInput) {
							org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunDocBrowserInformationControlInput input = (org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBrowserInformationControl.isAvailable(parent)) {
				org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBrowserInformationControl iControl = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public TestrunTextHover(org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunHTMLPrinter.insertPageProlog(buffer, 0, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunTextHover.getStyleSheet());
			org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunHTMLPrinter.addPageEpilog(buffer);
			return new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.qualitune.jouleunit.android.testrun.resource.testrun.util.TestrunStreamUtil.getContent(styleSheetURL.openStream());
