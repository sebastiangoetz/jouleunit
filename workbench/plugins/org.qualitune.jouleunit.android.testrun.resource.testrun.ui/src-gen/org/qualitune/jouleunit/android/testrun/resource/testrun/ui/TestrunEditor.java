...
/**
 * A text editor for 'testrun' models.
 * <p>
 * This editor has id
 * <code>org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor<
 * /code>
 * The editor's context menu has id
 * <code>org.qualitune.jouleunit.android.testrun.resource.testrun.EditorContext</co
 * de>.
 * The editor's ruler context menu has id
 * <code>org.qualitune.jouleunit.android.testrun.resource.testrun.EditorRuler</code
 * >.
 * </p>
 */
public class TestrunEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunResourceProvider, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.ITestrunBracketHandlerProvider, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.ITestrunAnnotationModelProvider {
	
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunCodeFoldingManager codeFoldingManager;
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBackgroundParsingStrategy bgParsingStrategy = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBackgroundParsingStrategy();
	private java.util.Collection<org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBackgroundParsingListener>();
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunColorManager colorManager = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunColorManager();
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunOutlinePage outlinePage;
	...
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPropertySheetPage propertySheetPage;
	...
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.ITestrunBracketHandler bracketHandler;
	...
	public TestrunEditor() {
		super();
		setSourceViewerConfiguration(new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), TestrunEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource currentResource = getResource();
				...
				org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.qualitune.jouleunit.android.testrun.resource.testrun.EditorContext");
		setRulerContextMenuId("org.qualitune.jouleunit.android.testrun.resource.testrun.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunNature.activate(inputFile.getProject());
		...
		org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource loadedResource = (org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource) {
					setResource((org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the TestrunEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource textResource = (org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource) element.eResource();
			...
			org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextToken token = lexer.getNextToken();
			...
			org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!TestrunEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.qualitune.jouleunit.android.testrun.resource.testrun.ui.ITestrunBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.qualitune.jouleunit.android.testrun.resource.testrun.ui.ITestrunBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource)) {
					return false;
				}
				org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource textResource = (org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource) resource;
				org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
