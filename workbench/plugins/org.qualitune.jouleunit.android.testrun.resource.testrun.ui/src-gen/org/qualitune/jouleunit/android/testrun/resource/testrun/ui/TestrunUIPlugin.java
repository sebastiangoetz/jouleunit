 ...
 */
public class TestrunUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.qualitune.jouleunit.android.testrun.resource.testrun.ui";
	public static final String EDITOR_ID = "org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor";
	...
	private static TestrunUIPlugin plugin;
	
	public TestrunUIPlugin() {
		super();
	}
	...
	public static TestrunUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, TestrunUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, TestrunUIPlugin.PLUGIN_ID, message);
		}
		final TestrunUIPlugin pluginInstance = TestrunUIPlugin.getDefault();
