 ...
 */
public class TestrunHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPositionHelper positionHelper = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPositionHelper();
	...
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunTokenScanner scanner;
	...
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunOccurrence occurrence;
	private org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public TestrunHighlighting(org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunColorManager colorManager, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunTokenScanner(textResource, colorManager);
		occurrence = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
