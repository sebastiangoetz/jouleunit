 ...
 */
public class TestrunBracketSet {
	...
	private java.util.ArrayList<org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBracketPair {
	 ...
	 */
	private class ClosingListener implements org.qualitune.jouleunit.android.testrun.resource.testrun.ui.ITestrunBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public TestrunBracketSet(org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBracketPair>();
	 ...
	 */
	public org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBracketPair getBracketPair(String opening, String closing) {
		for (org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBracketPair bracketPair : bracketPairs) {
	...
	public org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBracketPair remove(String opening, String closing) {
		for (org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.qualitune.jouleunit.android.testrun.resource.testrun.ITestrunBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.qualitune.jouleunit.android.testrun.resource.testrun.ui.TestrunPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
