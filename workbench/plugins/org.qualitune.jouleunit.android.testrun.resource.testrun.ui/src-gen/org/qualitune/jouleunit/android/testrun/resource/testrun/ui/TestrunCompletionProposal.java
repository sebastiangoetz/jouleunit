 ...
 */
public class TestrunCompletionProposal implements java.lang.Comparable<TestrunCompletionProposal> {
	 ...
	 */
	private org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunExpectedTerminal expectedTerminal;
	...
	public TestrunCompletionProposal(org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public TestrunCompletionProposal(org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
	...
	public org.qualitune.jouleunit.android.testrun.resource.testrun.mopp.TestrunExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof TestrunCompletionProposal) {
			TestrunCompletionProposal other = (TestrunCompletionProposal) object;
	...
	public int compareTo(TestrunCompletionProposal object) {
		if (object instanceof TestrunCompletionProposal) {
			TestrunCompletionProposal other = (TestrunCompletionProposal) object;
