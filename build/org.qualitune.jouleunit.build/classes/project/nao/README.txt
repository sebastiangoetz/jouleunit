This is the Nao profiling part of the JouleUnit framework.

Requires the Nao Service Utility classes to connect to the Nao. The Nao 
Service can be obtained from http://code.google.com/p/naoservice/
